...
from vln_carla2.usecases.scene.ports.scene_object_recorder import SceneObjectRecorderPort
...
class SpectatorCameraPort(Protocol):
    """Read spectator transform for XY sampling."""

    def get_spectator_transform(self) -> _TransformLike:
        ...


class SpawnVehiclePort(Protocol):
    """Spawn one vehicle actor from a DTO request."""
...
class SpawnVehicleAtSpectatorXY:
    ...
    spawn_vehicle: SpawnVehiclePort
