...
def to_tracking_run_request(command: TrackingRunCommand) -> TrackingRunRequest:
    return TrackingRunRequest(
        ...
        enable_camera_log=command.enable_camera_log,
        camera_log_dir=command.camera_log_dir,
        camera_width=command.camera_width,
        camera_height=command.camera_height,
        camera_fov=command.camera_fov,
        camera_jpeg_quality=command.camera_jpeg_quality,
        target_tick_log_path=command.target_tick_log_path,
        planner=command.planner,
        embed_forbidden_zone=command.embed_forbidden_zone,
    )
